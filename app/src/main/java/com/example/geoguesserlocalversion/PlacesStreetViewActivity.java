...
public class PlacesStreetViewActivity extends AppCompatActivity implements OnStreetViewPanoramaReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_places_street_view);
        ...
        giveUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PlacesStreetViewActivity.this, MapsActivity2.class);
        ...
        answer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PlacesStreetViewActivity.this, EndScreen.class);
                intent.putExtra("latitude", randomLocation.latitude);
                intent.putExtra("longitude", randomLocation.longitude);
                startActivity(intent);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                while (!isStreetViewLoaded) {
                    final LatLng randomLocation = new LatLng(latitude,longitude);
    ...
    private void onStreetViewNotLoaded() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(PlacesStreetViewActivity.this, "Loading...", Toast.LENGTH_SHORT).show();
